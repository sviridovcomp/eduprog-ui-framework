...
declare const _default: ComponentMeta<React.FC<import("../Button").ButtonPropsType>>;
export default _default;
export declare const Playground: ComponentStory<React.FC<import("../Button").ButtonPropsType>>;
